...
echo ""
echo "First time? Initialize a project:"
echo "  python \"${SOURCE_DIR}/scripts/edict_tasks_init.py\" --path <your-project>"
echo ""
echo "  (Existing .edict/edict-tasks.json will NOT be overwritten unless you pass --force)"
